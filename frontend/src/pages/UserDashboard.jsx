            ...
            <div className="premium-dropdown-overlay" onClick={() => setMenuOpen(false)}>
              <div className="premium-dropdown-menu" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="premium-menu-items">
                  <button className="premium-menu-item" onClick={() => { navigate('/dashboard'); setMenuOpen(false); }}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                    </svg>
                    <span>Dashboard</span>
                  </button>
                  <button className="premium-menu-item" onClick={() => { navigate('/dashboard/bookings'); setMenuOpen(false); }}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <button className="premium-menu-item" onClick={() => { navigate('/dashboard/profile'); setMenuOpen(false); }}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
